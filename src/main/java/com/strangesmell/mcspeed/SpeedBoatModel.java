...
public class SpeedBoatModel extends ListModel<SpeedBoat> implements WaterPatchModel {
    ...
    public SpeedBoatModel(ModelPart pRoot) {
     ...
     */
    public void setupAnim(SpeedBoat pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
